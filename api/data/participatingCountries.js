/**
 * 참전국 정보 데이터
 * 각 참전국의 기본 정보와 한국전쟁 참전 내용을 담고 있습니다.
 */

// 참전국 데이터 구조
// @typedef {Object} ParticipatingCountry
// @property {string} id - 고유 식별자 (URL 슬러그로 사용)
// @property {string} nameKo - 한국어 국가명
// @property {string} nameEn - 영어 국가명
// @property {'combat' | 'medical' | 'material' | 'intent'} supportType - 지원 유형
// @property {string} flagCode - 국기 코드 (ISO)
// @property {number} [troops] - 총 파병 병력 수
// @property {Object} [period] - 참전 기간
// @property {string} period.start - 참전 시작일
// @property {string} period.end - 참전 종료일
// @property {Object} [casualties] - 인명 피해
// @property {number} casualties.killed - 전사자 수
// @property {number} casualties.wounded - 부상자 수
// @property {number} casualties.missing - 실종자 수
// @property {string} contributions - 주요 기여 내용
// @property {string} background - 국가 배경
// @property {string} relationship - 한국과의 관계
// @property {string} [imageUrl] - 이미지 URL (선택사항)
